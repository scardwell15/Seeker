...
public class SKR_plagueEffect {
    ...
    public static void ApplyPlague(ShipVariantAPI shipVariant) {
        ...
        if (shipVariant.getHullMods().contains(IMMUNE_HULLMOD_A) || shipVariant.getHullMods().contains(IMMUNE_HULLMOD_B))
            return;
     ...
     *
     * @param shipVariant Variant of the ship affected by the plague
     * @return Uncapped CR reduction caused by the infected weapons
     */
    ...
    /**
     * @param shipVariant Variant of the ship affected by the nano-plague
